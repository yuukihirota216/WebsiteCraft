    ...
    <section id="merit-badges" className="px-4 py-8" style={{ backgroundColor: 'var(--line-green)' }}>
      ...
      <div className="space-y-6">
        <div className="flex items-start space-x-4 bg-white rounded-lg p-4">
          <div 
            className="flex-shrink-0 w-20 h-20 rounded-full border-2 flex items-center justify-center"
            style={{ 
              backgroundColor: 'var(--hero-bg)', 
              borderColor: 'var(--trust-blue)' 
            }}
          >
            <span className="text-2xl font-black" style={{ color: 'var(--trust-blue)' }}>01</span>
          </div>
          <div>
        ...
        <div className="flex items-start space-x-4 bg-white rounded-lg p-4">
          ...
          >
            <span className="text-2xl font-black" style={{ color: 'var(--trust-blue)' }}>02</span>
          </div>
          <div>
        ...
        <div className="flex items-start space-x-4 bg-white rounded-lg p-4">
          ...
          >
            <span className="text-2xl font-black" style={{ color: 'var(--trust-blue)' }}>03</span>
          </div>
          <div>
