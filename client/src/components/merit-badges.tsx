    ...
    <section id="merit-badges" className="px-4 py-8" style={{ backgroundColor: 'var(--line-green)' }}>
      ...
      <div className="space-y-6">
        <div className="flex items-start space-x-4 bg-white rounded-lg p-4">
          ...
          >
            <span className="text-xl font-black" style={{ color: 'var(--trust-blue)' }}>01</span>
          </div>
        ...
        <div className="flex items-start space-x-4 bg-white rounded-lg p-4">
          ...
          >
            <span className="text-xl font-black" style={{ color: 'var(--trust-blue)' }}>02</span>
          </div>
          <div className="flex-1 pt-1">
        ...
        <div className="flex items-start space-x-4 bg-white rounded-lg p-4">
          ...
          >
            <span className="text-xl font-black" style={{ color: 'var(--trust-blue)' }}>03</span>
          </div>
          <div className="flex-1 pt-1">
